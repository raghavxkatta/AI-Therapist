    ...
    return (
        <>
            ...
            <div className="md:hidden fixed top-4 left-4 z-50">
                <Button variant="ghost" size="sm" onClick={() => setMobileOpen(true)} className="h-10 w-10 p-0">
                ...
                {mobileOpen && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            exit={{ x: -300 }}
                            transition={{ duration: 0.3 }}
                            className="relative w-4/5 max-w-xs bg-sidebar border-r border-sidebar-border shadow-lg h-full flex flex-col"
                        >
                            ...
                            <ScrollArea className="flex-1 px-3 py-4">
                                <div className="space-y-12">
                                    <NavigationSection title="Main" items={navigationItems} isCollapsed={false} pathname={pathname} />
                                    <NavigationSection title="Support" items={supportItems} isCollapsed={false} pathname={pathname} />
                                </div>
                            </ScrollArea>
            ...
            <motion.div
                ...
                className={cn("hidden md:fixed md:left-0 md:top-0 z-30 h-screen bg-sidebar border-r border-sidebar-border flex flex-col shadow-lg md:block", className)}
            >
                <div className="flex items-center justify-between p-4 border-b border-sidebar-border">
                    <AnimatePresence>
                        {!isCollapsed && (
